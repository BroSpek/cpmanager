...
4.  **Configure Voucher Parameters** (in the "Generate Vouchers" dialog):
    ...
    * **Validity**: This defines how long a voucher will be active *once a user redeems it*.
    ...
    * **Expires In**: This sets the lifespan of an *unused* voucher. After this period, an unredeemed voucher will automatically expire.
